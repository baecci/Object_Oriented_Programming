...
Student::Student() : IOInterface(){  //기본 클래스 생성자 명시적 호출
...
Student::Student(string name, int hakbun, int subnum, Subject* sub) : IOInterface(name, 300){
