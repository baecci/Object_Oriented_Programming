...
Subject::Subject() : IOInterface(){  //기본 클래스 생성자 명시적 호출
...
Subject::Subject(string name, int hakjum, string grade) : IOInterface(name, 100){
...
Subject::Subject(const Subject& sub) : IOInterface(){
